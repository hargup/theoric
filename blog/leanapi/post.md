---
description: "LeanAPI is a backend framework for Lean 4 that lets you prove properties across the API, domain logic, and database interface."
author: Harsh Gupta
...
Every claim is listed in [EVIDENCE.md](https://github.com/theoriclabs/leanapi/blob/main/EVIDENCE.md) as **proved**, **checked**, **assumed** or **open**. The table is generated from a registry of theorems. The build refuses to call a claim "proved" if its theorem uses `sorry` or any axiom beyond Lean's standard three.
