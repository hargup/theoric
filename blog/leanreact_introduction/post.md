---
description: "LeanReact 0.1: compose React components in Lean, where the compiler checks your checkout states, editors, and forms."
author: Harsh Gupta
...
Start with the checkout type. Then swap the ticket editor, or remove a branch from the checkout match and read the compiler's response. The [how-to guide](https://github.com/theoriclabs/lean-react/blob/main/docs/HOW_TO.md) walks through building your own form.
