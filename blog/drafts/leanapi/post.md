---
description: "A FastAPI / Express alternative for Lean 4, with theorems about your whole backend, database included."
author: Harsh Gupta
...
Every claim is listed in [EVIDENCE.md](https://github.com/theoriclabs/leanapi/blob/main/EVIDENCE.md) as **proved**, **checked**, **assumed** or **open**. The table is generated from a registry of theorems, and the build refuses to call a claim "proved" if its theorem uses `sorry` or an extra axiom.
